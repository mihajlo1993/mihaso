...
export const workExperiences: WorkExperience[] = [
  ...
  },
  {
    ...
    description:
      "UI/UX Innovation, Insightful Research, Information Architecture Strategy, Cross-Functional Collaboration Excellence.",
    keyContributions: [
      "Visual Storytelling",
    ...
    skills: ["Design Leadership", "Mobile Design", "Research", "Visual Design"],
    year: 2019,
  },
  {
    id: "upwork",
